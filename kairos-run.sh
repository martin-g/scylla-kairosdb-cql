...
sed -i "s/kairosdb.datastore.cassandra.cql_host_list=.*/kairosdb.datastore.cassandra.cql_host_list=$IP/" /opt/kairosdb/conf/kairosdb.properties
...
while ! echo exit | nc $IP 9042; do sleep 10; done
